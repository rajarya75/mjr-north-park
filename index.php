...
<br>
						<div class="wow fadeInLeft" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInLeft; text-align:center;">
						<h1 class="title textcolor"><span style="font-weight:600;">MJR North Park</span></h2>
						<h2 class="title textcolor"><span style="font-weight:600;">Aerospace Park, Bagalur, North Bengaluru</span></h2><Br>
...
<div class="row">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 text-center align-middle" style="background: rgba(000, 54, 54, 0.0); height:80px; line-height:0px!important; padding-top:25px;">
		<table class="table table-dark" style="text-align: center; margin: auto; width: 100%; color:#fff; background: rgba(000, 54, 54, 0.1);border-style: inset; font-size:1.0rem;" border="0">
			<thead class="compact">
				<tr>
					...
					<th class="">
						<h5>Super Builtup Area</h5>
					</th>					
					<th class="text-center" style="padding-right:30px;">
						<h5>Price</h5>
					</th>
				</tr>
			</thead>	
			<tbody>			
			   ...
			   <tr>
				...
				<tr>
					<td scope="row" style="padding-left:20px;">4 BHK</td>
					<td>2075 Sq.ft.</td>					
					<td class="text-center">
						<button type="button" class="buttoncolor" data-toggle="modal" data-target="#price" style="padding: 15px !important; background-color: #17a2b8; color:#fff; border : 3px;">Ask Price</button>
					</td>
		...
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center headertext centered-thing ">
			...
			<div  class="btn btn-info"><h2>THRIVING INVESTMENT LANDSCAPE</h2></div>
			  ...
			  <p class="card-text">
				...
				Rs.1,15,000 Crore, signaling a promising future for the region.
			  </p>
			  </div>
			</div>
		</div>		
...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-4 col-md-4 col-sm-12">
			<a href="images/gallery/01.jpg" data-lightbox="gallery"><div class="artistic-impression">Artistic Impression</div><img class="img-fluid" src="images/gallery/01.jpg" loading="lazy" width="100%"></a>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-12">
			<a href="images/gallery/02.jpg" data-lightbox="gallery"><div class="artistic-impression">Artistic Impression</div><img class="img-fluid" src="images/gallery/02.jpg" loading="lazy" width="100%"></a>
		</div>	
		<div class="col-lg-4 col-md-4 col-sm-12">
			<a href="images/gallery/03.jpg" data-lightbox="gallery"><div class="artistic-impression">Artistic Impression</div><img class="img-fluid" src="images/gallery/03.jpg" loading="lazy" width="100%"></a>
		</div>		
	</div><br>
...
<section id="location"> <br><Br>
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12">
				<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15541.007816863972!2d77.678728!3d13.146501!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1b0010c5d1d7%3A0xb367cec1a1b2bb53!2sMJR%20North%20Park!5e0!3m2!1sen!2sin!4v1708268607535!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			</div>			
		</div>
	</div><br>
</section>
...
<!-- forms start price-->
<form name="contact-price" action="thankyou.php" method="POST">
